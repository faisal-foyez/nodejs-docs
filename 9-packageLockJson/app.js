 ...
 * In package.json you can set which versions you want to upgrade to (patch or minor), 
 * using the semver notation, for example:
 * if you write ~0.13.0, you want to only update patch releases: 0.13.1 is ok, but 0.14.0 is not.
 * if you write ^0.13.0, you want to get updates that do not change 
 * the leftmost non-zero number: 0.13.1, 0.13.2 and so on. 
 * If you write ^1.13.0, you will get patch and minor releases: 1.13.1, 1.14.0 and so on up to 2.0.0 
 * but not 2.0.0.
